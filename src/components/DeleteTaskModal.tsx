...
import { unsetTaskDelete, deleteTask, setNotification } from '../store/actions'
...
const DeleteTaskModal: FC<IProps> = ({ taskToDelete: { task, list } }) => {
  const dispatch = useDispatch()
  
  const closeModalHandler = () => dispatch(unsetTaskDelete())
